...
const HERO_SUBTITLES = [
    'Мужчина, 34 года, родился 4 октября 1989\nТелефон: +7(920)29-79-484\nE-mail: bolshartd@gmail.com',
...
HERO_DOTS.forEach((dot, index) => dot.addEventListener('click', () => {
    ...
    HERO_SUBTITLE.classList.add('clean');
}));
...
$(".benefits__date img[alt='shpalann']").click(function () {
    $('.benefits__date[data-name="Июнь 2023 — Октябрь 2023"]').toggleClass('benefits__date-active');
});
...
$(".benefits__date img[alt='yandex']").click(function () {
    $('.benefits__date[data-name="Ноябрь 2023 — н.в."]').toggleClass('benefits__date-active');
});

//Год
const date = new Date().getFullYear();
document.querySelector('.footer__copyright').textContent = date;